...
def runFRE(X_tr,y_tr,X_tst,y_tst,FI_X,y_nn,maxLen,prunning_ths,RW_measure):
  ...
  # return acc1,acc2,auc_tst,GM,NF,NR,ARL,Fidelity,ths,chi
  return ths,chi
...
if __name__ == '__main__':
  ...
  runFRE(X_tr,y_tr,X_tst,y_tst,FI_X,y_nn,maxLen=3,prunning_ths=0.5,RW_measure='PCF_CS')    #RW_PCF  RW_PCF_CS RW_non_fuzzy_conf
